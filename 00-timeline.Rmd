...
- Outline the tools / environments we aim to focus on in the short / medium term: R, blogdown, bookdown, GitHub, (Twitter/Youtube?/Discord?)
- Brainstorm requirements for tool inter-operability
- Write out a clear set of principles we adhere to, define (or find and reuse) a code of conduct
...
- Make some cool graphs to illustrate key parts of the narrative. E.g. the research cycle and the cycle from data to knowledge graphs and back
